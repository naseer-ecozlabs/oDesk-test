...
/**
 * @package oDesk Test
 * @copyright (c) 2014 Ecoz Labs (Pvt) Ltd.
 * @author M.J Muhammadh Naseer
 * @title Tech Lead
 * @Website http://www.ecozlabs.com
 * @link https://www.odesk.com/users/~0181127ab470e35c12 oDesk profile link of the developer.
 */
		  const SPACING_X = 1;
		  const SPACING_Y = 0;
		  const JOINT_CHAR = '+';
